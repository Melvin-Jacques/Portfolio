    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8 py-8">
        ...
        <a href="#/project/Slice" class="relative block overflow-hidden rounded-lg shadow transition hover:shadow-lg">
          ...
          <div class="relative bg-gradient-to-t from-gray-900/80 to-gray-900/25 pt-32 sm:pt-48 lg:pt-64">
            <div class="p-4 sm:p-6">
              <time datetime="2022-10-10" class="block text-xs text-white/90 font-bold">Feb 2023</time>
              ...
              <span class="inline-flex items-center justify-center whitespace-nowrap rounded-full bg-pink-500/65 border-2 border-pink-500 px-2.5 py-0.5 text-xs text-white font-semibold">
                WAMP
              </span>
      ...
      <div class="relative rounded-lg bg-gray-200">
        <a href="#/project/ColocApp" class="relative block overflow-hidden rounded-lg shadow transition hover:shadow-lg">
          ...
          <div class="relative bg-gradient-to-t from-gray-900/80 to-gray-900/25 pt-32 sm:pt-48 lg:pt-64">
            <div class="p-4 sm:p-6">
              <time datetime="2022-10-10" class="block text-xs text-white/90 font-bold">Late May 2023</time>
              ...
              <p class="mt-2 line-clamp-3 text-sm/relaxed text-white/95">
                ColocApp est une application web pour simplifier la gestion de colocation. Elle permet aux colocataires d’organiser leurs tâches partagées et de mieux communiquer. L’application utilise une architecture séparée entre le front-end et le back-end.
              </p>
            </div>
          </div>
        </a>
